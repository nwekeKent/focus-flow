...
export default function Timer() {
  ...
  return (
    <View className="w-full bg-[#2E325A] mt-20 mb-12 max-w-[300px] h-[300px] md:w-[410px] md:h-[410px] md:max-w-[410px] rounded-full p-5 items-center justify-center relative">
      <View className="w-full h-full z-10  items-center justify-center relative">
